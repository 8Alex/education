...
{
    "img":"assets/images/Сaptain-America.jpg",
...
{
    "img":"assets/images/Black-widow.jpg",
    "name":"Черная вдова",
    "universe":"Marvel Comics",
...
function createPage() {
    ...
    let heroRatingsString = localStorage.getItem("heroRatings");
    let heroRatings;
    if (heroRatingsString == null) {
        heroRatings = new Map();
    } else {
        heroRatings = new Map(JSON.parse(heroRatingsString));
    }

    function getOrZero(name) {
        let result = heroRatings.get(name);
        if (result == null) {
            return 0;
        } else {
            return result;
    ...
    for (let hero of heroes) {
        heroContent += `<div>
    <figure>
        <img class="img" src="${hero.img}">
        <figcaption>
            <h2>${hero.name}</h2>
            <div class ="innerContainer">Вселенная:${hero.universe};</div>
            <div class ="innerContainer">Альтер эго:${hero.alterEgo};</div>
            <div class ="innerContainer">Род деятельности:${hero.career};</div>
            <div class ="innerContainer">Друзья:${hero.friends};</div>
            <div class ="innerContainer">Суперсилы:${hero.superpowers};</div>
            <div class ="innerContainer">Подробнее:${hero.more}</div>
            <div class="titleRating">Рейтинг:</div>
            <div class="rating rating_set">
                ...
                <div class="rating__value">${getOrZero(hero.name)}</div>
            </div>
        </figcaption> 
    </figure>
    </div>`;
        ...
        function setRating(rating) {
            ...
            for (let index = 0; index < ratingItems.length; index++) {
                ...
                ratingItem.addEventListener("click", function (e) {
                    ...
                    let heroName = parent.getElementsByTagName("h2")[0].innerText;
                    heroRatings.set(heroName, Number(ratingValue.innerText));
                    console.log(heroRatings);
                    localStorage.setItem("heroRatings", JSON.stringify(Array.from(heroRatings.entries())));
                });
            }
        }
    }
